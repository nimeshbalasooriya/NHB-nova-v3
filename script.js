...
function getCountryInfo(country) {
    const countries = {
        ...
        "uk": "The United Kingdom is a sovereign country located off the northwestern coast of mainland Europe. It consists of four countries: England, Scotland, Wales, and Northern Ireland.",
        "australia": "Australia is a country and continent surrounded by the Indian and Pacific oceans, known for its unique wildlife and natural landscapes."
    };

    return countries[country] || (currentLanguage === "si" ? "මට මෙය ගැන වැඩිදුර විස්තර නැත." : "I don't have information about this country.");
            }
